...
<img src="/images/sqli-lab01/sqli-lab1-4.png" style="max-width:100%;">
...
![SQLi Lab Screenshot](/images/sqli-lab01/sqli-lab1-1.png)
...
Let's try replacing ' with '--, which will end the query and return 0 products. 
...
Expected Query: `SELECT * FROM products WHERE category = ''-- AND released = 1`
...
<img src="/images/sqli-lab01/sqli-lab1-2.png" style="max-width:100%;">
...
<img src="/images/sqli-lab01/sqli-lab1-3.png" style="max-width:100%;">
...
<img src="/images/sqli-lab01/sqli-lab1-6.png" style="max-width:100%;">

Download the FoxyProxy extension and add the Burp Suite proxy address and port.
<img src="/images/sqli-lab01/sqli-lab1-5.png" style="max-width:100%;">

<img src="/images/sqli-lab01/sqli-lab1-7.png" style="max-width:100%;">
...
<img src="/images/sqli-lab01/sqli-lab1-10.png" style="max-width:100%;">
...
<img src="/images/sqli-lab01/sqli-lab1-11.png" style="max-width:100%;">
...
<img src="/images/sqli-lab01/sqli-lab1-8.png" style="max-width:100%;">
...
et voilà! Little bobby tables would be very happy :-) 
